...
<div style="display: flex; flex-wrap: wrap; gap: 10px;">
  ...
  <img width="569" alt="image" src="https://github.com/joondoogg/Project/assets/146046027/fb4427da-7251-4ce4-889f-b855e7c8059a">
   ...
   - 두 번째 사진은 O(n^2) 알고리즘까지 포함하여 n=10,000까지 실행하였으며, O(n^2) 또한 확실한 실행시간 차이가 났습니다. algo_with_n2.py의 실행결과입니다.
...
이상으로 제 프로젝트 발표를 마칩니다. 총 한 학기 전체를 걸쳐서 4개의 프로젝트를 완성할 수 있었으며, 주로 교수님의 수업을 듣고 심화학습을 하여 구성하였습니다. 수업에서 배운 것들을 토대로 numpy 및 matplotlib의 다양한 내장함수를 사용하는 프로젝트를 구현해보면서 파이썬에 대한 이해도가 한 층 깊어졌습니다. 또한 릿코드를 풀면서 알고리즘에 대해서도 발을 들여 공부를 하게 되었고, 심화적인 내용(다익스트라 알고리즘)까지 공부해보고 구현할 수 있는 좋은 기회였습니다.
감사합니다.
